...
class JobOfferAnalysis:
    ...
    # mention — a été demandé à l'IA pendant une journée, puis
    # retiré : mesuré sur treize annonces, il gonflait
    # systématiquement et variait d'un appel à l'autre sur un texte
    # identique. Il est lu dans l'annonce, par
    # services.requirement_importance.
